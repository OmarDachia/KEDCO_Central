...
MIDDLEWARE = [
    ...
    # "errorHandler.middleware.django_middleware.ErrorHandlerMiddleware",
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "errorHandler.middleware.api_middleware.drf_exception_handler",
}
...
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_PASS", '%EsD(8Wzl&4~')
DEFAULT_FROM_EMAIL = "KEDCO CENTRAL <noreply@kedco.ng>"
SITE_ID = 1
